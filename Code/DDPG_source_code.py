...
[文档]@POLICY_REGISTRY.register('ddpg')
...
[文档]    def default_model(self) -> Tuple[str, List[str]]:
        """
        Overview:
...
[文档]    def _forward_learn(self, data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Overview:
...
[文档]    def _state_dict_learn(self) -> Dict[str, Any]:
        """
        Overview:
...
[文档]    def _load_state_dict_learn(self, state_dict: Dict[str, Any]) -> None:
        """
        Overview:
...
[文档]    def _init_collect(self) -> None:
        """
        Overview:
...
[文档]    def _forward_collect(self, data: Dict[int, Any], **kwargs) -> Dict[int, Any]:
        """
        Overview:
...
[文档]    def _process_transition(self, obs: torch.Tensor, policy_output: Dict[str, torch.Tensor],
...
[文档]    def _get_train_sample(self, transitions: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
        Overview:
...
[文档]    def _forward_eval(self, data: Dict[int, Any]) -> Dict[int, Any]:
        """
        Overview:
...
[文档]    def _monitor_vars_learn(self) -> List[str]:
        """
        Overview:
